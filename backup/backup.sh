...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/arismaramar/akses/main/ijin > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/arismaramar/akses/main/ijin | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/arismaramar/akses/main/ijin | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
MYIP=$(curl -sS ipv4.icanhazip.com)
NameUser=$(curl -sS https://raw.githubusercontent.com/arismaramar/akses/main/ijin | grep $MYIP | awk '{print $2}')
...
cp -r /var/lib/hokagevpn-pro/ /root/backup/hokagevpn-pro &> /dev/null
...
LLatest=`date`
Get_Data () {
git clone https://github.com/arismaramar/backup.git /root/user-backup/ &> /dev/null
}
...
Save_And_Exit () {
    ...
    git remote add origin https://github.com/arismaramar/backup
    git push -f https://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@github.com/arismaramar/backup.git &> /dev/null
}
...
link="https://raw.githubusercontent.com/arismaramar/backup/main/$NameUser/$NameUser.zip"
sleep 1
