...
cekdata=$(curl -sS https://raw.githubusercontent.com/YakkoXCode74/userbackup/main/$NameUser/$NameUser.zip | grep 404 | awk '{print $1}' | cut -d: -f1)
...
wget -q -O /root/backup/backup.zip "https://raw.githubusercontent.com/arismaramar/backup/main/$NameUser/$NameUser.zip" &> /dev/null
...
sleep 1
cp -r /root/backup/hokagevpn-pro /var/lib/ &> /dev/null
cp -r /root/backup/.acme.sh /root/ &> /dev/null
cp -r /root/backup/hokagevpn /etc/ &> /dev/null
